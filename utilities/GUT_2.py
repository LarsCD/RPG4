...
class GUT:
    ...
    def menu_select(self, menu_options, title=None, text=None, bar_text="", error_text=None,
                    clear_screen=False, draw_line=False) -> str:
    ...
    def display_text(self, title, text, options=None, bar_text="", error_text=None) -> str:
