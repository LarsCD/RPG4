...
Inventory.contents()['placeholder_apple'].destroy()
Inventory.contents()['placeholder_apple'].use_weapon()
Inventory.contents()['throwable_apple'].use_weapon()
Inventory.contents()['orkian_battle_axe'].use_weapon()
